<div>
    ...
    @foreach($data as $d)
        ...
        @endif
        <div class="mb-4">
            <div class="text-small float-right font-weight-bold text-muted">{{ ($d->score/($c[$d->id]*4)*100<33)?'Rendah':($d->score/($c[$d->id]*4)*100<66)?'menengah':'tinggi' }} ( {{$d->score/($c[$d->id]*4)*100}}%) </div>
